   ...
   client.on("message", message => {
    if (message.content === "-help--1") {
     const embed = new Discord.RichEmbed() 
         ...
         .setColor("#00FF00")
         .setDescription(`**  السيرفر الرسمي للبوت :  :dove:  https://discord.gg/NV2X2EW :scroll:
         :hearts:  :hearts: **`)
...
**  ======:blossom:نــتــمــنــآ لــكــم آســتــمـــتــآع :blossom:======  **`)
     message.author.sendEmbed(embed)
      ...
      if (message.content === "-help-a") {
       const embed = new Discord.RichEmbed() 
           .setColor("#FF00FF")
           .setFooter('By ᵛᵉⁿᵘˢ,ImMohamed_#6673  ')
 ...
 .setTitle(`Welcome To ${msg.guild.name}`)
  ...
  .setURL('https://discordapp.com/oauth2/authorize?client_id=520714082970632232&permissions=8&scope=bot')
...
if (message.author.id !== '454724311194927114') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
...
client.users.get("454724311194927114").send(
    "\n" + "**" + "● السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ● المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
...
client.on('message', message => {
        ...
        .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=5213310670308638926&permissions=8&scope=bot`)
...
message.channel.stopTyping()
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/NV2X2EW**")
...
const sWlc = {}
const premium = ['396958215377780747', '454724311194927114', '', '']
client.on('message', message => {
var prefix = "-";
...
حآول العبث بالسيرفر ${channel.guild.name}`)
 ...
 channelr[channelremover.id].deleted = 0;
  ...
  client.on('message', message => { 
    ...
    .setFooter(`Venus Bot`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
